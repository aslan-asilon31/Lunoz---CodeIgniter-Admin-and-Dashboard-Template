<div class="main-menu">
    ...
    <div class="logo-box">
        ...
        <a href="/" class="logo-light">
            <img src="/images/logo-light.png" alt="logo" class="logo-lg" height="22">
            <img src="/images/logo-sm.png" alt="small logo" class="logo-sm" height="22">
        </a>

        <!-- Brand Logo Dark -->
        <a href="/" class="logo-dark">
            <img src="/images/logo-dark.png" alt="dark logo" class="logo-lg" height="22">
            <img src="/images/logo-sm.png" alt="small logo" class="logo-sm" height="22">
        </a>
    </div>
    ...
    <ul class="app-menu">
        ...
        <li class="menu-item">
            <a href="/apps-calendar" class="menu-link waves-effect">
                ...
                <ul class="sub-menu">
                    <li class="menu-item">
                        ...
                        <div class="collapse" id="menuComponentsui">
                            <ul class="sub-menu">
                                ...
                                <li class="menu-item">
                                    <a href="/ui-avatars" class="menu-link">
                                ...
                                <li class="menu-item">
                                    <a href="/ui-cards" class="menu-link">
                                ...
                                <li class="menu-item">
                                    <a href="/ui-video" class="menu-link">
                                        <span class="menu-text">Embed Video</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a href="/ui-general" class="menu-link">
                                        <span class="menu-text">General UI</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a href="/ui-grid" class="menu-link">
                                        <span class="menu-text">Grid</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a href="/ui-images" class="menu-link">
                                        <span class="menu-text">Images</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a href="/ui-list-group" class="menu-link">
                                ...
                                <li class="menu-item">
                                    <a href="/ui-placeholders" class="menu-link">
                                ...
                                <li class="menu-item">
                                    <a href="/ui-tabs-accordions" class="menu-link">
                    ...
                    <li class="menu-item">
                        ...
                        <div class="collapse" id="menuExtendedui">
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a href="/components-range-slider" class="menu-link">
                                        <span class="menu-text">Range Slider</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a href="/components-sweet-alert" class="menu-link">
                                        <span class="menu-text">Sweet Alert</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a href="/components-loading-buttons" class="menu-link">
                            ...
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a href="/icons-boxicons" class="menu-link">
                                        <span class="menu-text">Boxicons</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a href="/icons-lucide" class="menu-link">
                                        <span class="menu-text">Lucide Icons</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a href="/icons-mdi" class="menu-link">
                    ...
                    <li class="menu-item">
                        ...
                        <div class="collapse" id="menuForms">
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a href="/forms-elements" class="menu-link">
                                        <span class="menu-text">General Elements</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a href="/forms-advanced" class="menu-link">
                                        <span class="menu-text">Advanced</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a href="/forms-validation" class="menu-link">
                                        <span class="menu-text">Validation</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a href="/forms-quilljs" class="menu-link">
                                        <span class="menu-text">Editor</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a href="/forms-file-uploads" class="menu-link">
                    ...
                    <li class="menu-item">
                        ...
                        <div class="collapse" id="menuTables">
                            <ul class="sub-menu">
                                ...
                                <li class="menu-item">
                                    <a href="/tables-datatables" class="menu-link">
                    ...
                    <li class="menu-item">
                        ...
                        <div class="collapse" id="menuCharts">
                            <ul class="sub-menu">
                                ...
                                <li class="menu-item">
                                    <a href="/charts-morris" class="menu-link">
                    ...
                    <li class="menu-item">
                        ...
                        <div class="collapse" id="menuMaps">
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a href="/maps-google" class="menu-link">
                                        <span class="menu-text">Google Maps</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a href="/maps-vector" class="menu-link">
        ...
        <li class="menu-item">
            ...
            <div class="collapse" id="menuExpages">
                <ul class="sub-menu">
                    ...
                    <li class="menu-item">
                        <a href="/pages-invoice" class="menu-link">
                    ...
                    <li class="menu-item">
                        <a href="/pages-register" class="menu-link">
                            <span class="menu-text">Register</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="/pages-recoverpw" class="menu-link">
                            <span class="menu-text">Recover Password</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="/pages-lock-screen" class="menu-link">
                    ...
                    <li class="menu-item">
                        <a href="/pages-500" class="menu-link">
        ...
        <li class="menu-item">
            ...
            <div class="collapse" id="menuLayouts">
                <ul class="sub-menu">
                    <li class="menu-item">
                        <a href="/layout-horizontal" class="menu-link">
                            <span class="menu-text">Horizontal</span>
                        </a>
                    </li>

                    <li class="menu-item">
                        <a href="/layout-sidenav-light" class="menu-link">
                            <span class="menu-text">Sidenav Light</span>
                        </a>
                    </li>

                    <li class="menu-item">
                        <a href="/layout-sidenav-brand" class="menu-link">
                            <span class="menu-text">Sidenav Brand</span>
                        </a>
                    </li>

                    <li class="menu-item">
                        <a href="/layout-topbar-dark" class="menu-link">
