        ...
        <div class="page-content">
            ...
            <div class="px-3">
                ...
                <div class="container-fluid">
                    ...
                    <?php echo view("partials/page-title", array("title" => "Buttons", "subtitle" => "Base UI")) ?>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="button-list">
                                        ...
                                        <button type="button" class="btn btn-success btn-sm waves-effect waves-light">Btn Small</button>
