        ...
        <div class="page-content">
            ...
            <div class="px-3">
                ...
                <div class="container-fluid">
                    ...
                    <?php echo view("partials/page-title", array("title" => "Cards", "subtitle" => "Base UI")) ?>

                    <div class="row">
                        <div class="col-lg-6 col-xl-3">
                            <!-- Simple card -->
                            <div class="card">
                                <img class="card-img-top img-fluid" src="/images/media/img-1.jpg" alt="Card image cap" />
                                <div class="card-body">
                        ...
                        <div class="col-lg-6 col-xl-3">
                            <div class="card">
                                <img class="card-img-top img-fluid" src="/images/media/img-2.jpg" alt="Card image cap" />
                                <div class="card-body">
                                    <h5 class="card-title">Card title</h5>
                        ...
                        <div class="col-lg-6 col-xl-3">
                            <div class="card">
                                <img class="card-img-top img-fluid" src="/images/media/img-3.jpg" alt="Card image cap" />
                                <div class="card-body">
                                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content. With supporting text below as a natural lead-in to additional content.</p>
                                    <a href="javascript:void(0);" class="btn btn-primary waves-effect waves-light">Button</a>
                                </div>
                        ...
                        <div class="col-lg-6 col-xl-3">
                            <div class="card">
                                ...
                                <img class="img-fluid" src="/images/media/img-4.jpg" alt="Card image cap" />
                                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card">
                                <img class="card-img-top img-fluid" src="/images/media/img-5.jpg" alt="Card image cap" />
                                <div class="card-body">
                                    <h5 class="card-title">Card title</h5>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                ...
                                <img class="card-img-bottom img-fluid" src="/images/media/img-6.jpg" alt="Card image cap" />
                            </div>
                            <!-- end card-box-->
                        </div>
                        <!-- end col -->
                        <div class="col-md-4">
                            <div class="card card-inverse text-white">
                                <img class="card-img img-fluid" src="/images/media/img-7.jpg" alt="Card image" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="card mb-3">
                                <div class="row g-0">
                                    <div class="col-md-4">
                                        <img src="/images/media/img-4.jpg" alt="Card image" class="img-fluid" />
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            <h5 class="card-title">Card title</h5>
                        ...
                        <div class="col-lg-6">
                            <div class="card mb-3">
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-4">
                                        <img src="/images/media/img-5.jpg" alt="Card image" class="img-fluid" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            ...
                            <div class="row row-cols-1 row-cols-md-3 g-3">
                                <div class="col">
                                    <div class="card">
                                        <img src="/images/media/img-4.jpg" class="card-img-top" alt="Card image" />
                                        <div class="card-body">
                                            <h5 class="card-title">Card title</h5>
                                ...
                                <div class="col">
                                    <div class="card">
                                        <img src="/images/media/img-6.jpg" class="card-img-top" alt="Card image" />
                                        <div class="card-body">
                                            <h5 class="card-title">Card title</h5>
                                            <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                                        </div>
                                ...
                                <div class="col">
                                    <div class="card">
                                        <img src="/images/media/img-5.jpg" class="card-img-top" alt="Card image" />
                                        <div class="card-body">
                                            <h5 class="card-title">Card title</h5>
