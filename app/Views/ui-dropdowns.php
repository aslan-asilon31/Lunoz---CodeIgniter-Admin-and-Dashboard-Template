        ...
        <div class="page-content">
            ...
            <div class="px-3">
                ...
                <div class="container-fluid">
                    ...
                    <?php echo view("partials/page-title", array("title" => "Dropdowns", "subtitle" => "Base UI")) ?>
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="mt-5">
                                                ...
                                                <div class="btn-group mt-2 me-1 dropend">
                                                    ...
                                                    <button type="button" class="btn btn-primary waves-effect dropdown-toggle-split dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            ...
                                            <div class="mt-5">
                                                ...
                                                <div class="btn-group dropup mt-2 me-1">
                                                    <button type="button" class="btn btn-primary waves-effect waves-light dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropup <i class="mdi mdi-chevron-up"></i></button>
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="#">Action</a>
                                                        <a class="dropdown-item" href="#">Another action</a>
                                                        <a class="dropdown-item" href="#">Something else here</a>
