        ...
        <div class="page-content">
            ...
            <div class="px-3">
                ...
                <div class="container-fluid">
                    ...
                    <?php echo view("partials/page-title", array("title" => "Modals", "subtitle" => "Base UI")) ?>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="button-list">
                                        ...
                                        <!-- Full Screen modal -->
                                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#full-screen-modal">Full Screen Modal</button>
                                        <!-- Full width modal -->
                                        <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#full-width-modal">Full width Modal</button>
                                        <!-- Scrollable modal -->
