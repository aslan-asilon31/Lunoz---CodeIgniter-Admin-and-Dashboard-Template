        ...
        <div class="page-content">
            ...
            <div class="px-3">
                ...
                <div class="container-fluid">
                    ...
                    <?php echo view("partials/page-title", array("title" => "Calendar", "subtitle" => "Apps")) ?>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <button class="btn btn-lg font-size-16 btn-primary w-100" id="btn-new-event"><i class="mdi mdi-plus-circle-outline"></i> Create New Event</button>
