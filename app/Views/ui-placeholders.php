        ...
        <div class="page-content">
            ...
            <div class="px-3">
                ...
                <div class="container-fluid">
                    ...
                    <?php echo view("partials/page-title", array("title" => "Placeholders", "subtitle" => "Base UI")) ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="card border shadow-none mb-md-0">
                                                <img src="/images/media/img-2.jpg" class="card-img-top" alt="...">
                                        ...
                                        <div class="col-md-6">
                                            <div class="card border shadow-none mb-0" aria-hidden="true">
                                                <img src="/images/media/img-4.jpg" class="card-img-top" alt="...">
                                                <div class="card-body">
